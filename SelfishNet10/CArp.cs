...
namespace SelfishNet10
{
	public class CArp : IDisposable
	{
		...
		public int startArpDiscovery()
		{
			...
			if (!this.isDiscovering)
			{
				/* modopt(System.Runtime.CompilerServices.IsConst) */ Thread thread = new Thread(new ThreadStart(this.discoverer));
		...
		public int startArpListener()
		{
			...
			if (!this.isListeningArp)
			{
				/* modopt(System.Runtime.CompilerServices.IsConst) */ Thread thread = new Thread(new ThreadStart(this.arpListener));
		...
		public int startRedirector()
		{
			...
			if (!this.isRedirecting)
			{
				/* modopt(System.Runtime.CompilerServices.IsConst) */ Thread thread = new Thread(new ThreadStart(this.redirector));
